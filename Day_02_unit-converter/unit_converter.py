...
value = st.number_input("Enter value:", min_value=1.0, step=1.0) # min_value is parameter and 1.0 is an argument
# Function parameters (min_value) defined value of specific parameter of function (which is 1.0 in this case)
# min_value=1.0 is a function parameter for st.number_input(), and 1.0 is the argument assigned to it.
...
if st.button("Convert"):
    ...
    st.success(f"Converted Value: {result}")  # Display the result